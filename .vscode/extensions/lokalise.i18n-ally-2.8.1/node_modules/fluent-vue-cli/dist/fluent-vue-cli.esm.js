...
import { FluentSerializer, parse, Message, Identifier, serialize } from '@fluent/syntax';
...
function merge$1(ftlSource, messages) {
    ...
    for (const [key, value] of Object.entries(messages)) {
        ...
        if (!updated) {
            const newMessage = new Message(new Identifier(key), resource.body[0].value);
...
export { getMessages$1 as getFtlMessages, getMessages as getVueMessages, merge$1 as mergeFtl, merge as mergeVue };
