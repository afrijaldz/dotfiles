# Generated by Powerlevel10k configuration wizard on 2023-01-12 at 17:02 WIB.
...
# flat heads, flat tails, 2 lines, disconnected, left frame, dark-ornaments, sparse,
...
() {
  ...
  # Don't define the background job icon. If you don't want to show background jobs, you can
  # set it to "". If you don't see the icon in your prompt, it could be because the font
  # doesn't contain the symbol. In that case, set POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION
  # to a string you'd like to see.
  ...
  ##################################[ context: user@hostname ]##################################
  # Context color when running with privileges (e.g. root).
  ...
  # Text and color for overtype (a.k.a. overwrite) vi mode.
  ...
  # commands will contain the start time of the command rather than the end time of
  # the command when the prompt was generated.
  ...
  # User-defined segment. Uncomment the following lines to enable it.
  # typeset -g POWERLEVEL9K_EXAMPLE_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # function prompt_example() {
  #   p10k segment -b 4 -f 3 -i '⭐' -t 'hello, %n'
  # }
}
